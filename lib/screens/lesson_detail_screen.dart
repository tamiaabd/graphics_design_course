    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [widget.module.color, Colors.white],
          stops: const [0.0, 0.2],
        ),
      ),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    if (widget.module.number ==
                        graphicDesignCourse.modules.length)
                      Padding(
                        padding: const EdgeInsets.all(20),
                        child: SizedBox(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Bullet Points
                  if (lesson.bulletPoints != null &&
                      lesson.bulletPoints!.isNotEmpty) ...[
                    const Divider(),
                    const SizedBox(height: 12),
                    ...lesson.bulletPoints!.map(
                      (point) => Padding(
